...
from airexo.helpers import rotation_utils as rtu
...
def average_xyz_rot_quat(xyz_rot1, xyz_rot2, rotation_rep, rotation_rep_convention = None):
    """
    Average two transformation poses using quaternions.
    """
    mid1 = xyz_rot_transform(
        xyz_rot1,
        from_rep = rotation_rep,
        to_rep = "quaternion",
        from_convention = rotation_rep_convention
    )
    mid2 = xyz_rot_transform(
        xyz_rot2,
        from_rep = rotation_rep,
        to_rep = "quaternion",
        from_convention = rotation_rep_convention
