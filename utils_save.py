...
def run_dual_arm_trajectory(
    ...
    if save_joint_csv:
        ...
        pd.DataFrame(all_rows, columns=colnames).to_csv("joint_data/solved_joint_trajectory2.csv", index=False)
        print(f"✅ Joint 数据已保存到 joint_data/solved_joint_trajectory2.csv")
